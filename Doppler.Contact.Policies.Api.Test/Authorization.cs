...
namespace Doppler.Contact.Policies.Api.Test
{
    public class Authorization : IClassFixture<WebApplicationFactory<Startup>>
    {
        ...
        [InlineData("/accounts/test1@test.com/settings", TOKEN_SUPERUSER_FALSE_EXPIRE_20330518, HttpStatusCode.Forbidden)]
        [InlineData("/accounts/test2@test.com/settings", TOKEN_ACCOUNT_123_TEST1_AT_TEST_DOT_COM_EXPIRE_20330518, HttpStatusCode.Forbidden)]
        ...
        [InlineData("/accounts/test1@test.com/settings", TOKEN_ACCOUNT_123_TEST1_AT_TEST_DOT_COM_EXPIRE_20330518, HttpStatusCode.OK)]
